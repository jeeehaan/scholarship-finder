...
from .views import ScholarshipListView, ScholarshipDetailView, TriggerScrapeTaskView, TestQueryView, ScholarshipSemanticSearchView
...
urlpatterns = [
    ...
    path("search/", ScholarshipSemanticSearchView.as_view(), name="search"),
]
